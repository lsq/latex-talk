...
\setbeamertemplate{title page}{%
	\raggedright
	\includegraphics[height=1cm]{figures/blue.png}
...
\title{Excel \& VBA操作培训}
%\title{Excel \& VBA入门培训}
\subtitle{Useful Excel Tips}
\author{刘军晓}
\institute{深圳市AA有限公司\quad 财务部}
\date{\zhtoday}
\titlegraphic{%
%  \includegraphics[height=1cm]{figures/badam.png}
  \vspace{3.4cm}
  \qrcode[hyperlink, height=1.6cm]{https://github.com/lsq/latex-talk}}
...
\input{include/function-PivotTable.tex}
\input{include/advanced.tex}
